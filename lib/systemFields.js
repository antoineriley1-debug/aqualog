 ...
 * !️ The NEW systems use TYPICAL DEFAULT RANGES — verify against your water treatment program.
 */
...
export const SYSTEM_META = {
  ...
  softener:      { label: 'Water Softener',    icon: '[SALT]' },
};
...
export const SYSTEM_FIELDS = {
  ...
  cooling_tower: [
    ...
    { key: 'conductivity', label: 'Conductivity', unit: 'µS/cm', min: 1000, max: 3000, presets: [1000, 1500, 2000, 3000] },
  ...
  condensate: [
    ...
    { key: 'hardness', label: 'Hardness', unit: 'ppm', min: 0, max: 0, targetZero: true, presets: [0] },
    { key: 'conductivity', label: 'Conductivity', unit: 'µS/cm', min: 0, max: 100, presets: [10, 25, 50, 100] },
    { key: 'amine', label: 'Amine Residual', unit: 'ppm', min: 0, max: 10, presets: [0, 2, 5, 8, 10] },
  ],
  softener: [
    { key: 'hardness', label: 'Hardness', unit: 'ppm', min: 0, max: 0, targetZero: true, presets: [0] },
    { key: 'conductivity', label: 'Conductivity', unit: 'µS/cm', min: 0, max: 1500, presets: [200, 500, 1000, 1500] },
  ],
};
...
export function systemIcon(system) { return SYSTEM_META[system]?.icon || '•'; }
