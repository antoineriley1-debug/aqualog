...
// Fallback user list for serverless deployments (Vercel) where the filesystem is read-only.
// These mirror data/users.json and are used when the file cannot be read.
const FALLBACK_USERS = [
  { id: 'usr_ariley', username: 'ariley',    password: '51351853',   role: 'admin',    hospital: null,    name: 'Antoine Riley',       email: 'antoine.riley@facilityh2o.com', active: true },
