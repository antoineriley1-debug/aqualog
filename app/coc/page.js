      ...
      <main className="flex-1 w-full min-w-0 p-4 md:p-8 pt-16 md:pt-8">
        ...
        <div id="coc-form" className="bg-white border-2 border-gray-800 rounded-xl print:rounded-none print:border-2 max-w-4xl mx-auto">
          ...
          <div className="flex items-start justify-between p-6 border-b-2 border-gray-800">
            <div>
              <div className="text-2xl font-black text-[#003366]">💧 AquaLog</div>
              <div className="text-sm font-semibold text-gray-600">MedStar Health · Water Chemistry Portal</div>
              <div className="text-xs text-gray-400 mt-1">Author: Antoine Riley · AquaLog</div>
            </div>
          ...
          <div className="p-6">
            ...
            <div className="text-xs text-gray-400 border-t border-gray-200 pt-4">
              COC #{form.cocNumber} · Generated by AquaLog — MedStar Health Water Chemistry Portal · Author: Antoine Riley ·{' '}
