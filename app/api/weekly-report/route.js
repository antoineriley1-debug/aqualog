...
<body style="font-family:Arial,sans-serif;background:#f9fafb;margin:0;padding:20px">
  <div style="max-width:700px;margin:0 auto;background:white;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.1)">
    ...
    <div style="padding:24px 32px">
      <p style="color:#374151;margin-bottom:20px">Compliance summary for all MedStar facilities — month-to-date scores with weekly activity.</p>
    ...
    if (process.env.RESEND_API_KEY && process.env.ALERT_EMAIL_TO) {
      try {
        ...
        await resend.emails.send({
          ...
          subject: `AquaLog Weekly Report — Week of ${weekDateLabel}`,
          html: htmlEmail,
        });
        emailSent = true;
      } catch (err) {
